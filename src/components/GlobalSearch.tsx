        ...
        <div className="relative w-full max-w-lg" ref={searchRef}>
            <div className="relative">
                ...
                <input
                    ...
                    className="block w-full rounded-md border-slate-300 bg-white py-2 pl-10 pr-3 text-sm placeholder:text-slate-400 focus:border-blue-500 focus:ring-blue-500"
                />
            </div>
