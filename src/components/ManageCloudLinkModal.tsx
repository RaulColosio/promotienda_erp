        ...
        <Modal isOpen={isOpen} onClose={onClose} title="Manage Cloud Link">
            <div className="space-y-4">
                <p className="text-sm text-slate-600">
                    Set a specific cloud folder URL for this deal, or clear it to use the primary contact's default folder.
                </p>
                <div>
                    <label htmlFor="cloud-link-url" className="block text-sm font-medium text-slate-700">Cloud Folder URL</label>
                     <div className="mt-1">
                        <input
                            type="url"
                            id="cloud-link-url"
